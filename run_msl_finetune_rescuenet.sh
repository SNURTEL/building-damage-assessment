...
pdm run scripts/train_test_msl.py --floodnet -d ../outputs/baseline_single_rescuenet/2024-12-31_04-36-19/.hydra -c /home/tomek/inz/inz/outputs/baseline_single_rescuenet/2024-12-31_04-36-19/checkpoints/experiment_name-0-epoch-26-step-3051-challenge_score_safe-0.8166-best-challenge-score.ckpt -n 10 --size min

pdm run scripts/train_test_msl.py --floodnet -d ../outputs/farseg_single_rescuenet/2024-12-31_03-05-59/.hydra -c /home/tomek/inz/inz/outputs/farseg_single_rescuenet/2024-12-31_03-05-59/checkpoints/experiment_name-0-epoch-37-step-4294-challenge_score_safe-0.8180-best-challenge-score.ckpt -n 10 --size min
